...
#ifndef BITCOIN_QT_DOMAINDIALOG_H
#define BITCOIN_QT_DOMAINDIALOG_H
...
static const int MAX_SEND_POPUP_ENTRIES_ = 10;
...
private slots:
    ...
    void on_buttonExplorer_clicked();
    void on_buttonMinimizeFee_clicked();
    void removeEntry(DomainEntry* entry);
...
#endif // BITCOIN_QT_DOMAINDIALOG_H
