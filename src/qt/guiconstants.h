...
/* SeoCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "SEOCOIN"
#define QAPP_ORG_DOMAIN "seocoin.org"
#define QAPP_APP_NAME_DEFAULT "SEOCOIN-Qt"
#define QAPP_APP_NAME_TESTNET "SEOCOIN-Qt-testnet"
