...
// Copyright (c) 2016-2018 The SEOCOIN developers
...
{   
    ...
    addWidget(domainPage);

    addWidget(explorerWindow);
    addWidget(domainWindow);
    ...
    connect(domainPage, SIGNAL(message(QString, QString, unsigned int)), this, SIGNAL(message(QString, QString, unsigned int)));
...
void WalletView::setClientModel(ClientModel* clientModel)
{
    ...
    domainPage->setClientModel(clientModel);
...
void WalletView::setWalletModel(WalletModel* walletModel)
{
    ...
    domainPage->setModel(walletModel);
...
void WalletView::gotoDomainExplorerPage()
{
    setCurrentWidget(domainWindow);
}
...
void WalletView::gotoDomainPage()
{
    setCurrentWidget(domainPage);
