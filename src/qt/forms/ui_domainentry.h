/********************************************************************************
** Form generated from reading UI file 'domainentry.ui'
**
...
#ifndef UI_DOMAINENTRY_H
#define UI_DOMAINENTRY_H
...
public:
    ...
    QLabel *labelDomainCode;
    QLineEdit *editDomainCode;
    QLabel *labelDomain;
    QLineEdit *editDomain;
    QLabel *labelTraffic;
    QLineEdit *editTraffic;
    QLabel *labelContact;
    QLineEdit *editContact;
    QLabel *labelOffer;
    QLineEdit *editOffer;
    QLabel *labelTracking;
    QLineEdit *editTracking;
    QLabel *messageLabel;
    ...
    void setupUi(QStackedWidget *DomainEntry)
    {
        if (DomainEntry->objectName().isEmpty())
            DomainEntry->setObjectName(QStringLiteral("DomainEntry"));
        DomainEntry->resize(729, 156);
        DomainEntry->setFocusPolicy(Qt::TabFocus);
        DomainEntry->setAutoFillBackground(false);
        ...
        labelDomainCode = new QLabel(SendCoins);
        labelDomainCode->setObjectName(QStringLiteral("labelDomainCode"));
        labelDomainCode->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);
        labelDomainCode->setWordWrap(true);

        gridLayout->addWidget(labelDomainCode, 4, 0, 1, 1);

        editDomainCode = new QLineEdit(SendCoins);
        editDomainCode->setObjectName(QStringLiteral("editDomainCode"));
        editDomainCode->setReadOnly(true);

        gridLayout->addWidget(editDomainCode, 4, 1, 1, 1);

        labelDomain = new QLabel(SendCoins);
        labelDomain->setObjectName(QStringLiteral("labelDomain"));
        labelDomain->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout->addWidget(labelDomain, 5, 0, 1, 1);

        editDomain = new QLineEdit(SendCoins);
        editDomain->setObjectName(QStringLiteral("editDomain"));

        gridLayout->addWidget(editDomain, 5, 1, 1, 1);

        labelTraffic = new QLabel(SendCoins);
        labelTraffic->setObjectName(QStringLiteral("labelTraffic"));
        labelTraffic->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout->addWidget(labelTraffic, 6, 0, 1, 1);

        editTraffic = new QLineEdit(SendCoins);
        editTraffic->setObjectName(QStringLiteral("editTraffic"));

        gridLayout->addWidget(editTraffic, 6, 1, 1, 1);

        labelContact = new QLabel(SendCoins);
        ...
        gridLayout->addWidget(labelContact, 7, 0, 1, 1);

        editContact = new QLineEdit(SendCoins);
        editContact->setObjectName(QStringLiteral("editContact"));

        gridLayout->addWidget(editContact, 7, 1, 1, 1);

        labelOffer = new QLabel(SendCoins);
        labelOffer->setObjectName(QStringLiteral("labelOffer"));
        labelOffer->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout->addWidget(labelOffer, 8, 0, 1, 1);

        editOffer = new QLineEdit(SendCoins);
        editOffer->setObjectName(QStringLiteral("editOffer"));

        gridLayout->addWidget(editOffer, 8, 1, 1, 1);

        labelTracking = new QLabel(SendCoins);
        labelTracking->setObjectName(QStringLiteral("labelTracking"));
        labelTracking->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout->addWidget(labelTracking, 9, 0, 1, 1);

        editTracking = new QLineEdit(SendCoins);
        editTracking->setObjectName(QStringLiteral("editTracking"));
        editTracking->setReadOnly(true);

        gridLayout->addWidget(editTracking, 9, 1, 1, 1);
        ...
        DomainEntry->addWidget(SendCoins);
        ...
        DomainEntry->addWidget(SendCoins_InsecurePaymentRequest);
        ...
        DomainEntry->addWidget(SendCoins_SecurePaymentRequest);
        ...
        retranslateUi(DomainEntry);

        QMetaObject::connectSlotsByName(DomainEntry);
    } // setupUi

    void retranslateUi(QStackedWidget *DomainEntry)
    {
#ifndef QT_NO_TOOLTIP
        SendCoins->setToolTip(QApplication::translate("DomainEntry", "This is a normal payment.", 0));
#endif // QT_NO_TOOLTIP
        payToLabel->setText(QApplication::translate("DomainEntry", "Pay &To:", 0));
#ifndef QT_NO_TOOLTIP
        payTo->setToolTip(QApplication::translate("DomainEntry", "The SEOCOIN address to send the payment to", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        addressBookButton->setToolTip(QApplication::translate("DomainEntry", "Choose previously used address", 0));
#endif // QT_NO_TOOLTIP
        addressBookButton->setText(QString());
        addressBookButton->setShortcut(QApplication::translate("DomainEntry", "Alt+A", 0));
#ifndef QT_NO_TOOLTIP
        pasteButton->setToolTip(QApplication::translate("DomainEntry", "Paste address from clipboard", 0));
#endif // QT_NO_TOOLTIP
        pasteButton->setText(QString());
        pasteButton->setShortcut(QApplication::translate("DomainEntry", "Alt+P", 0));
#ifndef QT_NO_TOOLTIP
        deleteButton->setToolTip(QApplication::translate("DomainEntry", "Remove this entry", 0));
#endif // QT_NO_TOOLTIP
        deleteButton->setText(QString());
        labelLabel->setText(QApplication::translate("DomainEntry", "&Label:", 0));
#ifndef QT_NO_TOOLTIP
        addAsLabel->setToolTip(QApplication::translate("DomainEntry", "Enter a label for this address to add it to the list of used addresses", 0));
#endif // QT_NO_TOOLTIP
        amountLabel->setText(QApplication::translate("DomainEntry", "A&mount:", 0));
        labelDomainCode->setText(QApplication::translate("DomainEntry", "Enable visitor tracking add following code domain index page:", 0));
#ifndef QT_NO_TOOLTIP
        editDomainCode->setToolTip(QApplication::translate("DomainEntry", "Code", 0));
#endif // QT_NO_TOOLTIP
        editDomainCode->setText(QApplication::translate("DomainEntry", "<iframe src='http://securebytes.pro/?your_domain_name.here' style='visibility:hidden' > ", 0));
        labelDomain->setText(QApplication::translate("DomainEntry", "Domain name:", 0));
#ifndef QT_NO_TOOLTIP
        editDomain->setToolTip(QApplication::translate("DomainEntry", "Enter domain name ", 0));
#endif // QT_NO_TOOLTIP
        labelTraffic->setText(QApplication::translate("DomainEntry", "Daily visitors:", 0));
#ifndef QT_NO_TOOLTIP
        editTraffic->setToolTip(QString());
#endif // QT_NO_TOOLTIP
        labelContact->setText(QApplication::translate("DomainEntry", "Contact info @/social:", 0));
#ifndef QT_NO_TOOLTIP
        editContact->setToolTip(QString());
#endif // QT_NO_TOOLTIP
        labelOffer->setText(QApplication::translate("DomainEntry", "Record type, FOR SALE, SOLD, LEASE", 0));
#ifndef QT_NO_TOOLTIP
        editOffer->setToolTip(QString());
#endif // QT_NO_TOOLTIP
        labelTracking->setText(QApplication::translate("DomainEntry", "Traffic tracking url", 0));
#ifndef QT_NO_TOOLTIP
        editTracking->setToolTip(QString());
#endif // QT_NO_TOOLTIP
        editTracking->setText(QApplication::translate("DomainEntry", "http://securebytes.pro/visitor.php?your_domain_name.here", 0));
        messageLabel->setText(QApplication::translate("DomainEntry", "Message:", 0));
#ifndef QT_NO_TOOLTIP
        messageTextLabel->setToolTip(QApplication::translate("DomainEntry", "A message that was attached to the SEOCOIN: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the SEOCOIN network.", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        SendCoins_InsecurePaymentRequest->setToolTip(QApplication::translate("DomainEntry", "This is an unverified payment request.", 0));
#endif // QT_NO_TOOLTIP
        payToLabel_is->setText(QApplication::translate("DomainEntry", "Pay To:", 0));
#ifndef QT_NO_TOOLTIP
        deleteButton_is->setToolTip(QApplication::translate("DomainEntry", "Remove this entry", 0));
#endif // QT_NO_TOOLTIP
        deleteButton_is->setText(QString());
        memoLabel_is->setText(QApplication::translate("DomainEntry", "Memo:", 0));
        amountLabel_is->setText(QApplication::translate("DomainEntry", "A&mount:", 0));
#ifndef QT_NO_TOOLTIP
        SendCoins_SecurePaymentRequest->setToolTip(QApplication::translate("DomainEntry", "This is a verified payment request.", 0));
#endif // QT_NO_TOOLTIP
        payToLabel_s->setText(QApplication::translate("DomainEntry", "Pay To:", 0));
#ifndef QT_NO_TOOLTIP
        deleteButton_s->setToolTip(QApplication::translate("DomainEntry", "Remove this entry", 0));
#endif // QT_NO_TOOLTIP
        deleteButton_s->setText(QString());
        memoLabel_s->setText(QApplication::translate("DomainEntry", "Memo:", 0));
        amountLabel_s->setText(QApplication::translate("DomainEntry", "A&mount:", 0));
        Q_UNUSED(DomainEntry);
    } // retranslateUi

};

namespace Ui {
    class DomainEntry: public Ui_DomainEntry {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_DOMAINENTRY_H
