...
public:
    ...
    void setupUi(QDialog *DomainDialog)
    {
        if (DomainDialog->objectName().isEmpty())
            DomainDialog->setObjectName(QStringLiteral("DomainDialog"));
        DomainDialog->setEnabled(true);
        DomainDialog->resize(978, 695);
        verticalLayout = new QVBoxLayout(DomainDialog);
        ...
        frame_Header = new QFrame(DomainDialog);
        ...
        frame_BG = new QFrame(DomainDialog);
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 SEO"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 SEO"));
        ...
        buttonExplorer = new QPushButton(frameFee);
        buttonExplorer->setObjectName(QStringLiteral("buttonExplorer"));

        horizontalLayoutSmartFee->addWidget(buttonExplorer);
        ...
        groupFee = new QButtonGroup(DomainDialog);
        ...
        groupCustomFee = new QButtonGroup(DomainDialog);
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/icons/domain"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        checkzSEO = new QCheckBox(frame_Send);
        checkzSEO->setObjectName(QStringLiteral("checkzSEO"));
        checkzSEO->setEnabled(false);

        horizontalLayout_2->addWidget(checkzSEO);
        ...
        labelBalance->setText(QStringLiteral("123.456 SEO"));
        ...
        retranslateUi(DomainDialog);

        sendButton->setDefault(true);


        QMetaObject::connectSlotsByName(DomainDialog);
    } // setupUi

    void retranslateUi(QDialog *DomainDialog)
    {
        DomainDialog->setWindowTitle(QApplication::translate("DomainDialog", "Add Domain", 0));
        labelOverviewHeaderLeft->setText(QApplication::translate("DomainDialog", "Domain record", 0));
        labelOverviewHeaderRight->setText(QString());
        labelCoinControlFeatures->setText(QApplication::translate("DomainDialog", "Coin Control Features", 0));
        pushButtonCoinControl->setText(QApplication::translate("DomainDialog", "Open Coin Control...", 0));
        labelCoinControlAutomaticallySelected->setText(QApplication::translate("DomainDialog", "Coins automatically selected", 0));
        labelCoinControlInsuffFunds->setText(QApplication::translate("DomainDialog", "Insufficient funds!", 0));
        labelCoinControlQuantityText->setText(QApplication::translate("DomainDialog", "Quantity:", 0));
        labelCoinControlBytesText->setText(QApplication::translate("DomainDialog", "Bytes:", 0));
        labelCoinControlAmountText->setText(QApplication::translate("DomainDialog", "Amount:", 0));
        labelCoinControlPriorityText->setText(QApplication::translate("DomainDialog", "Priority:", 0));
        labelCoinControlPriority->setText(QApplication::translate("DomainDialog", "medium", 0));
        labelCoinControlFeeText->setText(QApplication::translate("DomainDialog", "Fee:", 0));
        labelCoinControlLowOutputText->setText(QApplication::translate("DomainDialog", "Dust:", 0));
        labelCoinControlLowOutput->setText(QApplication::translate("DomainDialog", "no", 0));
        labelCoinControlAfterFeeText->setText(QApplication::translate("DomainDialog", "After Fee:", 0));
        labelCoinControlChangeText->setText(QApplication::translate("DomainDialog", "Change:", 0));
#ifndef QT_NO_TOOLTIP
        checkBoxCoinControlChange->setToolTip(QApplication::translate("DomainDialog", "If this is activated, but the change address is empty or invalid, change will be sent to a newly generated address.", 0));
#endif // QT_NO_TOOLTIP
        checkBoxCoinControlChange->setText(QApplication::translate("DomainDialog", "Custom change address", 0));
        labelCoinControlChangeLabel->setText(QString());
        splitBlockCheckBox->setText(QApplication::translate("DomainDialog", "Split UTXO", 0));
        splitBlockLineEdit->setPlaceholderText(QApplication::translate("DomainDialog", "# of outputs", 0));
        labelBlockSizeText->setText(QApplication::translate("DomainDialog", "UTXO Size:", 0));
        labelBlockSize->setText(QApplication::translate("DomainDialog", "0 SEO", 0));
        labelFeeHeadline->setText(QApplication::translate("DomainDialog", "Transaction Fee:", 0));
        labelFeeMinimized->setText(QString());
        buttonChooseFee->setText(QApplication::translate("DomainDialog", "Choose...", 0));
        buttonExplorer->setText(QApplication::translate("DomainDialog", "Domain Explorer", 0));
#ifndef QT_NO_TOOLTIP
        buttonMinimizeFee->setToolTip(QApplication::translate("DomainDialog", "collapse fee-settings", 0));
#endif // QT_NO_TOOLTIP
        buttonMinimizeFee->setText(QApplication::translate("DomainDialog", "Minimize", 0));
        radioCustomFee->setText(QString());
        labelCustomFee->setText(QApplication::translate("DomainDialog", "Custom:", 0));
#ifndef QT_NO_TOOLTIP
        radioCustomPerKilobyte->setToolTip(QApplication::translate("DomainDialog", "If the custom fee is set to 1000 uSEOs and the transaction is only 250 bytes, then \"per kilobyte\" only pays 250 uSEOs in fee,<br />while \"at least\" pays 1000 uSEOs. For transactions bigger than a kilobyte both pay by kilobyte.", 0));
#endif // QT_NO_TOOLTIP
        radioCustomPerKilobyte->setText(QApplication::translate("DomainDialog", "per kilobyte", 0));
#ifndef QT_NO_TOOLTIP
        radioCustomAtLeast->setToolTip(QApplication::translate("DomainDialog", "If the custom fee is set to 1000 uSEOs and the transaction is only 250 bytes, then \"per kilobyte\" only pays 250 uSEOs in fee,<br />while \"total at least\" pays 1000 uSEOs. For transactions bigger than a kilobyte both pay by kilobyte.", 0));
#endif // QT_NO_TOOLTIP
        radioCustomAtLeast->setText(QApplication::translate("DomainDialog", "total at least", 0));
#ifndef QT_NO_TOOLTIP
        checkBoxMinimumFee->setToolTip(QApplication::translate("DomainDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for SEOCOIN transactions than the network can process.", 0));
#endif // QT_NO_TOOLTIP
        checkBoxMinimumFee->setText(QString());
#ifndef QT_NO_TOOLTIP
        labelMinFeeWarning->setToolTip(QApplication::translate("DomainDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for SEOCOIN transactions than the network can process.", 0));
#endif // QT_NO_TOOLTIP
        labelMinFeeWarning->setText(QApplication::translate("DomainDialog", "(read the tooltip)", 0));
        labelSmartFee_2->setText(QApplication::translate("DomainDialog", "Recommended", 0));
        labelSmartFee3->setText(QApplication::translate("DomainDialog", "Confirmation time:", 0));
        labelSmartFeeNormal->setText(QApplication::translate("DomainDialog", "normal", 0));
        labelSmartFeeFast->setText(QApplication::translate("DomainDialog", "fast", 0));
        labelFeeEstimation->setText(QString());
        labelSmartFee2->setText(QApplication::translate("DomainDialog", "(Smart fee not initialized yet. This usually takes a few blocks...)", 0));
        labelSmartFee->setText(QString());
        radioSmartFee->setText(QString());
        checkBoxFreeTx->setText(QApplication::translate("DomainDialog", "Send as zero-fee transaction if possible", 0));
        labelFreeTx->setText(QApplication::translate("DomainDialog", "(confirmation may take longer)", 0));
#ifndef QT_NO_TOOLTIP
        sendButton->setToolTip(QApplication::translate("DomainDialog", "Confirm the send action", 0));
#endif // QT_NO_TOOLTIP
        sendButton->setText(QApplication::translate("DomainDialog", "S&end", 0));
#ifndef QT_NO_TOOLTIP
        clearButton->setToolTip(QApplication::translate("DomainDialog", "Clear all fields of the form.", 0));
#endif // QT_NO_TOOLTIP
        clearButton->setText(QApplication::translate("DomainDialog", "Clear &All", 0));
#ifndef QT_NO_TOOLTIP
        addButton->setToolTip(QApplication::translate("DomainDialog", "Send to multiple recipients at once", 0));
#endif // QT_NO_TOOLTIP
        addButton->setText(QApplication::translate("DomainDialog", "Add &Recipient", 0));
        checkzSEO->setText(QApplication::translate("DomainDialog", "Anonymized SEO", 0));
        checkSwiftTX->setText(QApplication::translate("DomainDialog", "SwiftX", 0));
        label->setText(QApplication::translate("DomainDialog", "Balance:", 0));
    } // retranslateUi

};

namespace Ui {
    class DomainDialog: public Ui_DomainDialog {};
} // namespace Ui
