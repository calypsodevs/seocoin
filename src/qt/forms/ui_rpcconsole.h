...
public:
    ...
    QLabel *wallet_customzclpbackuppath_label;
    QLabel *wallet_customzclpbackuppath;
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        wallet_customzclpbackuppath_label = new QLabel(tab_repair);
        wallet_customzclpbackuppath_label->setObjectName(QStringLiteral("wallet_customzclpbackuppath_label"));
        wallet_customzclpbackuppath_label->setVisible(false);

        gridLayout_4->addWidget(wallet_customzclpbackuppath_label, 4, 0, 1, 1);

        wallet_customzclpbackuppath = new QLabel(tab_repair);
        wallet_customzclpbackuppath->setObjectName(QStringLiteral("wallet_customzclpbackuppath"));
        wallet_customzclpbackuppath->setCursor(QCursor(Qt::IBeamCursor));
        wallet_customzclpbackuppath->setTextFormat(Qt::PlainText);
        wallet_customzclpbackuppath->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);
        wallet_customzclpbackuppath->setVisible(false);

        gridLayout_4->addWidget(wallet_customzclpbackuppath, 4, 1, 1, 3);
    ...
    void retranslateUi(QDialog *RPCConsole)
    {
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the SEOCOIN debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
        ...
        wallet_customzclpbackuppath_label->setText(QApplication::translate("RPCConsole", "Custom zSEO Backup Path:", 0));
        wallet_customzclpbackuppath->setText(QApplication::translate("RPCConsole", "N/A", 0));
