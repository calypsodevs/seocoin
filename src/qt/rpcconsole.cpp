                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzSEOPathCustom = GetArg("-zclpbackuppath", "");
    ...
    if(!strzSEOPathCustom.empty()) {
        ui->wallet_customzclpbackuppath->setText(QString::fromStdString(strzSEOPathCustom));
        ui->wallet_customzclpbackuppath_label->setVisible(true);
        ui->wallet_customzclpbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzSEOPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the SEOCOIN RPC console.") + "<br>" +
