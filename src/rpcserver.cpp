...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "SEOCOIN server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SEOCOIN features */
        {"seocoin", "masternode", &masternode, true, true, false},
        {"seocoin", "listmasternodes", &listmasternodes, true, true, false},
        {"seocoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"seocoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"seocoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"seocoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"seocoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"seocoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"seocoin", "masternodedebug", &masternodedebug, true, true, false},
        {"seocoin", "startmasternode", &startmasternode, true, true, false},
        {"seocoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"seocoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"seocoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"seocoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"seocoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"seocoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"seocoin", "mnbudget", &mnbudget, true, true, false},
        {"seocoin", "preparebudget", &preparebudget, true, true, false},
        {"seocoin", "submitbudget", &submitbudget, true, true, false},
        {"seocoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"seocoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"seocoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"seocoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"seocoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"seocoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"seocoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"seocoin", "checkbudgets", &checkbudgets, true, true, false},
        {"seocoin", "mnsync", &mnsync, true, true, false},
        {"seocoin", "spork", &spork, true, true, false},
        {"seocoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> seocoin-cli " + methodname + " " + args + "\n";
}
