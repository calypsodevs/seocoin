...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SeoCoin Core seocoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  seocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded seocoin transaction") + "\n" +
                               "  seocoin-tx [options] -create [commands]   " + _("Create hex-encoded seocoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded seocoin transaction
