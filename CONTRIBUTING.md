Contributing to SEOCOIN Core
============================

The SEOCOIN Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SEOCOIN Core project, and is not to be
confused with overall SEOCOIN Network Protocol consensus changes.

Whether a pull request is merged into SEOCOIN Core rests with the project merge
...
Patches that change SEOCOIN consensus rules are considerably more involved than
...
Where a patch set proposes to change the SEOCOIN consensus, it must have been
...
The project leader is the release manager for each SEOCOIN Core release.
