...
In order to support loading of multiple wallets in seocoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is seocoin.cpp.
...
Changes to seocoin.cpp
----------------------
seocoin.cpp is the entry point into seocoin-qt, and as such, will require some minor modifications to provide hooks for
