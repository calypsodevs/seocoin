...
This mechanism has been integrated into Bitcore-Node-SEOCOIN which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/SEOCOIN-Project/insight-api-seocoin#web-socket-api](https://github.com/SEOCOIN-Project/insight-api-seocoin#web-socket-api) 
* API: [https://github.com/SEOCOIN-Project/insight-api-seocoin#swifttx-transactions](https://github.com/SEOCOIN-Project/insight-api-seocoin#swifttx-transactions) 
...
By default, the SEOCOIN Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the SEOCOIN Core daemon:
